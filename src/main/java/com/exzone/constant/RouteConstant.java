...
public interface RouteConstant {
    ...
    //Biller sub-modules
    String BILLER_SUBMODULE = DOT + "biller" + DOT;
    String USER_BILLER_INDEX = USER + BILLER_SUBMODULE + INDEX;
    String USER_BILLER_CREATE = USER + BILLER_SUBMODULE + CREATE;
    String USER_BILLER_SHOW = USER + BILLER_SUBMODULE + SHOW;
    String USER_BILLER_UPDATE = USER + BILLER_SUBMODULE + UPDATE;
    String USER_BILLER_AUDITS = USER + BILLER_SUBMODULE + "audits";
    String USER_BILLER_ACCOUNTLOOKUP = USER + BILLER_SUBMODULE + "account-lookup";
    String USER_BILLER_LISTS = USER + BILLER_SUBMODULE + "lists";
    String USER_BILLER_SIGNUPACCOUNT = USER + BILLER_SUBMODULE + "signUpAccount";
    String USER_BILLER_SIGNUPACCOUNTOTP = USER + BILLER_SUBMODULE + "signUpAccountOtp";
    String USER_BILLER_SIGNUPACCOUNTVERIFY = USER + BILLER_SUBMODULE + "signUpAccountVerify";
